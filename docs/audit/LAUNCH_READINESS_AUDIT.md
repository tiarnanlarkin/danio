...
> Public Git history retains the old exposure, and the canonical privacy and terms URLs require current external hosting and content verification. This historical audit is not current approval.
