...
> Public Git history retains the old exposure, and the canonical privacy and terms URLs require current external hosting and content verification. This historical dashboard is not current approval.
