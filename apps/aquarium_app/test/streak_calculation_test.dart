...
void main() {
  ...
  group('XP Management (without streak)', () {
    ...
    test('addXp increments XP without touching streak', () async {
      ...
      final initialLastActivity = profile.lastActivityDate;
      ...
      expect(profile.lastActivityDate, initialLastActivity); // Unchanged
    });
    ...
    test('Lesson completion adds XP and lesson ID', () async {
      ...
      expect(profile.totalXp, 50); // Still 50, not 100
