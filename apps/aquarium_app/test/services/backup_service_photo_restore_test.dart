...
void main() {
  group('BackupService photo restore', () {
    ...
    test(
      'getBackupData ignores duplicate unreferenced archive photo filenames',
      () async {
        final zipPath = p.join(
          tempDir.path,
          'unreferenced_duplicate_photo_backup.zip',
        );
        await _writeBackupZip(
          zipPath,
          data: {
          ...
          files: {
            'photos/fish.jpg': 'referenced backup photo',
            'photos/left/orphan.jpg': 'left orphan backup photo',
            'photos/right/orphan.jpg': 'right orphan backup photo',
          },
        );
