...
| Tank tasks | Tank Detail | Tank Detail -> Tasks | Create/complete task | Empty title rejected | Today board reflects due tasks | App contract | [tasks](screenshots/production-tool-audit-2026-05-25/phase3-detail-route-tasks.png) | Pending |
