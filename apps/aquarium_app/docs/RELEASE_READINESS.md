...
> Public Git history retains the old exposure, and the canonical privacy and terms URLs require current external hosting and content verification. Older readiness evidence below is historical.
