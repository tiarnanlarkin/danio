...
| DCL-A11Y-001 | Phone accessibility remains open across contrast, touch targets, labels, text scaling, reduced motion, and non-colour-only status; clusters 1-2 are complete and three phone-quality clusters remain. | `DR-2026-07-24-077` binds permanent 2.0x Learn, Practice, and story selectors; minimal Learn/Practice wrapping fixes close both proved overflows after the cluster-1 Tank evidence. | `FINISH_MAP.md` Accessibility row; `docs/qa/phone-quality/2026-07-24/dcl-a11y-001-learn-practice-stories.md`; backlog `CL-P2-004`. | `VERIFY_LOCALLY` | open | Phone accessibility and visual polish | No | Each ordered phone cluster is audited with current screenshots and focused widget/accessibility paths; all concrete failures are fixed and the affected tests and Visual checks pass, with no untracked phone cluster remaining. |
| DCL-VIS-001 | Current phone assets and visual defects still need verification; clusters 1-2 are complete and three phone-quality clusters remain. | The active ocean-room/Neon Tetra rights basis, Tank clipping, and current Learn/Practice/story asset, contrast, and clipping audit are resolved with attributable evidence and current baselines; the March audit remains historical context only. | `docs/qa/phone-quality/2026-07-24/dcl-a11y-001-learn-practice-stories.md`; `docs/design/BASELINES.md`. | `VERIFY_LOCALLY` | open | Phone visual polish | No | Current phone screenshots and repo assets are inspected; every concrete weak, mismatched, missing, licensed-source, clipping, or contrast defect is fixed with affected Visual proof, or no-current-gap evidence closes the row. There is no asset-replacement quota. |
| DCL-VIS-002 | Selective visual regression remains open after targeted cluster-1 and cluster-2 proof; three phone-quality clusters remain. | Current July phone screenshots, the existing golden harness, and permanent cluster-2 2.0x selectors provide the bounded baseline set. | `FINISH_MAP.md` Whole-app phone audit row; `docs/design/BASELINES.md`; `test/quality/visual_baseline_manifest_test.dart`; `docs/qa/phone-quality/2026-07-24/dcl-a11y-001-learn-practice-stories.md`. | `VERIFY_LOCALLY` | open | Phone visual polish | No | The baseline manifest points to current phone evidence, changed high-risk surfaces have targeted screenshot/golden proof where useful, and all current baseline checks pass; no minimum number of new goldens is required. |
...
| DCL-MOTION-001 | Global haptic-preference enforcement and clusters 1-2 evidence are complete; three phone-quality clusters remain for reduced-motion and quality evidence. | All product haptics route through one persisted preference-aware adapter; the source guard permits platform haptics only inside it; cluster 2 proves Practice answer-tile transitions become `Duration.zero` under reduced motion. | `DR-2026-07-22-068`; `DR-2026-07-24-077`; `FINISH_MAP.md` Motion and haptics row; `docs/qa/phone-quality/2026-07-24/dcl-a11y-001-learn-practice-stories.md`. | `VERIFY_LOCALLY` | open | Phone motion and visual polish | No | The global haptic adapter, source guard, zero-call disabled proof, and exact enabled-call proof pass; reduced-motion and the remaining quality checks pass across all five phone-quality clusters. |
