...
| DCL-A11Y-001 | Phone accessibility remains open; clusters 1-4 are complete and one phone-quality cluster remains. | `DR-2026-07-25-079` binds More/tools/species/rewards/preferences 2.0x reflow and targeted device proof after clusters 1-3. | `FINISH_MAP.md` Accessibility row; `docs/qa/phone-quality/2026-07-25/dcl-a11y-001-more-tools-species-rewards-preferences.md`; backlog `CL-P2-004`. | `VERIFY_LOCALLY` | open | Phone accessibility and visual polish | No | Cluster 5 is audited with current screenshots and focused paths; all concrete failures are fixed and affected tests/Visual checks pass. |
| DCL-VIS-001 | Current phone assets and visual defects still need final Cluster 5 verification; clusters 1-4 are complete and one phone-quality cluster remains. | Current Cluster 4 clipping, contrast, provenance, and affected screenshots are resolved; no asset bytes changed. | `docs/qa/phone-quality/2026-07-25/dcl-a11y-001-more-tools-species-rewards-preferences.md`; `docs/design/BASELINES.md`. | `VERIFY_LOCALLY` | open | Phone visual polish | No | Cluster 5 current phone screenshots and repo assets are inspected and every concrete P0/P1 defect is fixed or dispositioned. |
| DCL-VIS-002 | Selective visual regression remains open after targeted cluster-1 through cluster-4 proof; one phone-quality cluster remains. | Current July phone screenshots, golden harness, and permanent 2.0x selectors provide the bounded baseline set. | `FINISH_MAP.md` Whole-app phone audit row; `docs/design/BASELINES.md`; `test/quality/visual_baseline_manifest_test.dart`; `docs/qa/phone-quality/2026-07-25/dcl-a11y-001-more-tools-species-rewards-preferences.md`. | `VERIFY_LOCALLY` | open | Phone visual polish | No | Cluster 5 changed high-risk surfaces have targeted proof and current baseline checks pass; no minimum new-golden quota applies. |
...
| DCL-MOTION-001 | Global haptic-preference enforcement and clusters 1-4 evidence are complete; one phone-quality cluster remains. | All product haptics route through the persisted adapter; the source guard permits platform haptics only there. Cluster 4 adds no bypass and retains reduced-motion coverage. | `DR-2026-07-22-068`; `DR-2026-07-25-079`; `FINISH_MAP.md` Motion and haptics row. | `VERIFY_LOCALLY` | open | Phone motion and visual polish | No | The adapter/source guard proofs pass and Cluster 5 reduced-motion/haptic checks complete the ordered phone evidence. |
