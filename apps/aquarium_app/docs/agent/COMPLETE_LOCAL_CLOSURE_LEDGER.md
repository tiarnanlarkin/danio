...
| DCL-A11Y-001 | Phone accessibility remains open across contrast, touch targets, labels, text scaling, reduced motion, and non-colour-only status; clusters 1-3 are complete and two phone-quality clusters remain. | `DR-2026-07-24-078` binds permanent 2.0x Smart/no-key reflow, Optional-AI semantics, and reduced-motion selectors after the cluster-1 Tank and cluster-2 Learn/Practice/story evidence. | `FINISH_MAP.md` Accessibility row; `docs/qa/phone-quality/2026-07-25/dcl-a11y-001-smart-no-key-optional-ai.md`; backlog `CL-P2-004`. | `VERIFY_LOCALLY` | open | Phone accessibility and visual polish | No | Each ordered phone cluster is audited with current screenshots and focused widget/accessibility paths; all concrete failures are fixed and the affected tests and Visual checks pass, with no untracked phone cluster remaining. |
| DCL-VIS-001 | Current phone assets and visual defects still need verification; clusters 1-3 are complete and two phone-quality clusters remain. | The active ocean-room/Neon Tetra rights basis, Tank and Learn/Practice clipping, and current Smart/no-key/Optional-AI asset, contrast, and clipping audit are resolved with attributable evidence and current baselines; the March audit remains historical context only. | `docs/qa/phone-quality/2026-07-25/dcl-a11y-001-smart-no-key-optional-ai.md`; `docs/design/BASELINES.md`. | `VERIFY_LOCALLY` | open | Phone visual polish | No | Current phone screenshots and repo assets are inspected; every concrete weak, mismatched, missing, licensed-source, clipping, or contrast defect is fixed with affected Visual proof, or no-current-gap evidence closes the row. There is no asset-replacement quota. |
| DCL-VIS-002 | Selective visual regression remains open after targeted cluster-1 through cluster-3 proof; two phone-quality clusters remain. | Current July phone screenshots, the existing golden harness, and permanent cluster-2/3 2.0x selectors provide the bounded baseline set. | `FINISH_MAP.md` Whole-app phone audit row; `docs/design/BASELINES.md`; `test/quality/visual_baseline_manifest_test.dart`; `docs/qa/phone-quality/2026-07-25/dcl-a11y-001-smart-no-key-optional-ai.md`. | `VERIFY_LOCALLY` | open | Phone visual polish | No | The baseline manifest points to current phone evidence, changed high-risk surfaces have targeted screenshot/golden proof where useful, and all current baseline checks pass; no minimum number of new goldens is required. |
...
| DCL-MOTION-001 | Global haptic-preference enforcement and clusters 1-3 evidence are complete; two phone-quality clusters remain for reduced-motion and quality evidence. | All product haptics route through one persisted preference-aware adapter; the source guard permits platform haptics only inside it; clusters 2-3 prove Practice and Smart/Optional-AI animations honor reduced motion. | `DR-2026-07-22-068`; `DR-2026-07-24-078`; `FINISH_MAP.md` Motion and haptics row; `docs/qa/phone-quality/2026-07-25/dcl-a11y-001-smart-no-key-optional-ai.md`. | `VERIFY_LOCALLY` | open | Phone motion and visual polish | No | The global haptic adapter, source guard, zero-call disabled proof, and exact enabled-call proof pass; reduced-motion and the remaining quality checks pass across all five phone-quality clusters. |
