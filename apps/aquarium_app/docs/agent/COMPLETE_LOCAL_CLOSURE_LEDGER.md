...
`DCL-DR-001` and `DCL-DR-002` are closed. `DCL-DR-002-F1` and `DCL-DR-002-F2`
are locally fixed; `DCL-DR-002-F3`, `DCL-DR-002-F4`, `DCL-DR-002-F5`,
`DCL-DR-002-F6`, `DCL-DR-002-F7`, and `DCL-DR-002-F8` are locally verified.
After this checkpoint is clean, pushed, and aligned, continue the next manual
verification-first
`DCL-DR-003` CRUD/undo resilience audit under marker
