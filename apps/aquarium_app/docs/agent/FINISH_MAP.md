...
| Learning | In progress | Structured guide coverage exists for all current paths, the placeholder placement CTA is hidden until a real flow exists, story play asks before leaving mid-story progress, and locked story cards explain unlock requirements. | Add richer visuals, practice links, scenarios, citations, and broader interaction variety. |
