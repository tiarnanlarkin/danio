...
relationship-mapping, or app-kill persistence gap is proven red, fixed green,
and then verified with the data-safety row of `QUALITY_LADDER.md`. Prefer
