...
| Learning | In progress | Structured guide coverage exists for all current paths, story play now asks before leaving mid-story progress, and locked story cards explain unlock requirements. | Add richer visuals, practice links, scenarios, citations, and broader interaction variety. |
