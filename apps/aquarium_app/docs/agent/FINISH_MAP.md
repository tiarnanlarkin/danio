...
| Debug QA seeds | In progress | Existing debug QA seeds now include demo tank, lesson quiz/practice, unlock/progression controls, emergency unsafe-water, and incompatible-fish tank seeds. | Add remaining seed states for skipped onboarding, unlock edge cases, tablet, and AI/no-AI. |
