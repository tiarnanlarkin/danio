...
| Debug QA seeds | In progress | Existing debug QA seeds now include demo tank, lesson quiz/practice, unlock/progression controls, and an emergency unsafe-water tank seed. | Add remaining seed states for incompatible fish, skipped onboarding, unlock edge cases, tablet, and AI/no-AI. |
