...
| Content validation | In progress | Content validator exists and runs in the focused gate, including emergency/distress lesson checks for educational positioning, aquatic-vet/professional escalation copy, direct prerequisite-free access, and UK-style litre/litres volume spelling in learning copy. | Expand validation for warnings, sources, duplicate IDs, bad ranges, and broader locked-content coverage. |
