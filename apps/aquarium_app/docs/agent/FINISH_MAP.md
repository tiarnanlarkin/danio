...
| Practice | Implemented | Skill Drills and scenario practice cover parameters, diagnosis, compatibility, setup, and emergency decisions, with widget coverage for SR provider error surfaces and legacy-card recall prompts. | Add persisted tool-result context only where walkthroughs prove it improves flow. |
