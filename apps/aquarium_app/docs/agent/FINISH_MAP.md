...
| Whole-app phone audit | In progress | Current 19-surface phone screenshot/XML pass exists under `docs/qa/screenshots/2026-07-04/cl-qa-001-phone-whole-app-map/`, with notes in `docs/qa/whole-app-phone-map-2026-07-04.md`; the Smart/Fish ID bottom-dock overlap and smoke tap false positive are fixed locally with tests, and the phone black-box smoke rerun passed. | Finish full CL-QA-001 inventory coverage, including phone Smart recapture after the dock fix. |
| Whole-app tablet audit | In progress | Current 19-surface tablet screenshot/XML pass exists under `docs/qa/screenshots/2026-07-04/cl-qa-002-tablet-whole-app-map/`, with notes in `docs/qa/whole-app-tablet-map-2026-07-04.md`; smoke route assertions/tap handling and lower More hub tablet swipes are hardened locally with tests, and the tablet black-box smoke rerun passed. | Finish full CL-QA-002 inventory coverage with pass/fail/gap notes for every remaining surface. |
