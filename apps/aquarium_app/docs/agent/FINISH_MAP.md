...
| Backup and restore | `DCL-DR-001,DCL-DR-002,DCL-DR-004` | In progress | `DR-2026-07-16-001` through `DR-2026-07-16-006` close `DCL-DR-001`. `DR-2026-07-16-007` makes both storage errors retryable; `DR-2026-07-16-008` records a corrupt-file path only after copy success and makes no-copy recovery wording honest; `DR-2026-07-16-009` proves real-file repaired and unchanged malformed retries without a product change. | Continue `DCL-DR-002-F4` under marker `danio-dcl-dr-002-start-fresh-cancel-back-proof-2026-07-16/1`; prove cancel/back has no destructive or false-success effect before assuming a product gap. |
...
`DCL-DR-002-F3` is locally verified. After this checkpoint is clean, pushed,
and aligned, continue the next manual start-fresh cancel/back proof under marker
`danio-dcl-dr-002-start-fresh-cancel-back-proof-2026-07-16/1`. Do not select
