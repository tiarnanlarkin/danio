...
`DCL-DR-003-F37` are settled evidence, but `DCL-DR-003` remains open. The
settled range is F1 through F37. Tasks, Equipment Mark Serviced, and single
livestock-add compensation are complete in `DR-2026-07-19-058` through
`DR-2026-07-19-060`; run the bounded Wishlist replay probe next.
