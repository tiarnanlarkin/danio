...
| UI/visual | Current visual target; focused widget/golden/screenshot where practical; `.\scripts\quality_gates\run_local_quality_gate.ps1 -Profile Visual` | Screenshot/golden path and inventory row | Phone and tablet proof required before Done. |
...
| Release candidate | Full gate; AndroidPrep; phone audit; tablet audit; content validation; visual baseline; product truth scan | Release QA doc and Finish Map | No public launch/store/legal hosting until complete-local bar is met. |
