...
| 2026-07-25 | Coordinator current Codex session | `emulator-5554` | `danio_api36` | `DR-2026-07-25-082` | Serial-pinned preflight; AndroidPrep; current-commit profile harness; clean debug install; three compact journeys and black-box smoke; exact app stop/launcher restore | `docs/qa/2026-07-25-dcl-rc-001-final-local-phone-candidate.md` | Yes; Danio stopped, launcher foreground, CheckOnly passed |
| 2026-08-01 | `codex:019fbcbe-2209-7e71-ab67-b8baf0d9be8f` coordinator | `emulator-5554` | `danio_api36` | `DR-2026-08-01-087` | Normal Quick Boot and serial-pinned preflight; current debug APK install; Temperature preset/Custom and Water route checks; temporary 2.0x font; screenshots, focus, and scoped log scans; exact 1.0 restore | `docs/qa/2026-08-01-temperature-water-android-integration.md` | Yes; Coldwater restored, Water panel open, emulator left running |
