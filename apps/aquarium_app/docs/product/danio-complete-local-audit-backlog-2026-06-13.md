...
Current verification note: as of the backup tank field validation slice on
2026-06-14, `flutter test` passes 1594 tests and `flutter analyze` is clean,
