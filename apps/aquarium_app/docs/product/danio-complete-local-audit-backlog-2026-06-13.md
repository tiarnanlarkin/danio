...
Current verification note: as of the optional-restore malformed child-record guard
slice on 2026-06-14, `flutter test` passes 1630 tests and `flutter analyze` is clean,
