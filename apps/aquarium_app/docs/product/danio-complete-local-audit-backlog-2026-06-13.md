...
Current verification note: as of the backup export missing-photo guard slice on
2026-06-14, `flutter test` passes 1635 tests and `flutter analyze` is clean,
