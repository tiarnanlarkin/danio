...
Current verification note: as of the backup required-date validation slice on
2026-06-14, `flutter test` passes 1572 tests and `flutter analyze` is clean,
