...
Current verification note: as of the backup required enum-field validation slice
on 2026-06-14, `flutter test` passes 1639 tests and `flutter analyze` is clean,
