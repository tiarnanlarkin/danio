...
Current verification note: as of the species add-to-tank handoff slice on
2026-06-13, `flutter test` passes 1453 tests and `flutter analyze` is clean,
