...
| CL-P1-003 | Species pages | Upgrade species/plant pages into beautiful actionable guides. | In progress; CL-P1-003A adds a simple missing-species request path from Fish Database empty search. Remaining: richer care pages, source trail, tank-specific actions, reminders, common problems, and plant-page parity. |
...
Current verification note: as of the missing species request path slice on
2026-06-13, `flutter test` passes 1444 tests and `flutter analyze` is clean,
