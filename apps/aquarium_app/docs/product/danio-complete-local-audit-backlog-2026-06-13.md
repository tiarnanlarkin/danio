...
Current verification note: as of the Reminder Intensity presets slice on
2026-06-13, `flutter test` passes 1541 tests and `flutter analyze` is clean,
