...
| CL-P1-003 | Species pages | Upgrade species/plant pages into beautiful actionable guides. | In progress; CL-P1-003A adds a simple missing-species request path from Fish Database empty search. CL-P1-003B adds data-derived Care Actions to fish species detail sheets. Remaining: richer care pages, source trail, tank-specific add/reminder actions, common problems, and plant-page parity. |
...
Current verification note: as of the species care actions slice on
2026-06-13, `flutter test` passes 1445 tests and `flutter analyze` is clean,
