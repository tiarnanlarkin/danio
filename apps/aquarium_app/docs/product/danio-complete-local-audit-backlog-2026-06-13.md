...
Current verification note: as of the backup child relationship-target validation
slice on 2026-06-14, `flutter test` passes 1621 tests and `flutter analyze` is clean,
