...
| ID | Area | Work | Acceptance |
| --- | --- | --- | --- |
| CL-QA-001 | Screen audit | Re-run a whole-app phone screenshot and XML audit against the complete-local bar. | In progress; 2026-07-04 pass captured current phone screenshot/XML evidence under `docs/qa/whole-app-phone-map-2026-07-04.md`. Smart/Fish ID bottom-dock overlap and smoke tap targeting are fixed locally, the phone black-box smoke rerun passed, after-fix Smart root recapture shows Fish & Plant ID clearing the dock by `47px`, QA-006 added 39 standalone deep-link captures, and all 96 `SCREEN_INVENTORY.md` rows now have phone `Pass` or `Gap` accounting with 56 passes and 40 gaps. Remaining: capture or route-smoke the 40 phone gap rows before treating the phone whole-app audit as current visual evidence. |
| CL-QA-002 | Tablet audit | Add tablet emulator/screenshot audit. | In progress; 2026-07-04 pass captured current tablet screenshot/XML evidence under `docs/qa/whole-app-tablet-map-2026-07-04.md`. Tablet smoke route assertions/taps and lower More hub swipes are hardened locally, the tablet black-box smoke rerun passed, QA-006 added 39 standalone deep-link captures, and all 96 `SCREEN_INVENTORY.md` rows now have tablet `Pass` or `Gap` accounting with 56 passes and 40 gaps. Remaining: capture or route-smoke the 40 tablet gap rows before treating the tablet whole-app audit as current visual evidence. |
