...
Current verification note: as of the backup log type payload validation slice
on 2026-06-14, `flutter test` passes 1667 tests and `flutter analyze` is
