...
Current verification note: as of the Preferences Privacy Policy route slice on
2026-06-13, `flutter test` passes 1542 tests and `flutter analyze` is clean,
