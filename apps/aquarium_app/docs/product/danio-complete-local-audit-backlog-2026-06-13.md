...
| CL-P1-002 | Rewards | Connect progression to meaningful unlocks: rooms, tank vibes, decorations, seasonal themes, badges, and achievement-based cosmetics. | In progress; CL-P1-002A adds room vibe unlocks in the theme picker using local species, XP, streak, lesson, perfect-score, and achievement progress. CL-P1-002B polishes achievement badge/category display so visible reward surfaces use controlled icons and plain labels. Remaining: deeper decoration/seasonal cosmetics and achievement-based tank cosmetics. |
...
Current verification note: as of the achievement badge display polish slice on
2026-06-13, `flutter test` passes 1433 tests and `flutter analyze` is clean,
