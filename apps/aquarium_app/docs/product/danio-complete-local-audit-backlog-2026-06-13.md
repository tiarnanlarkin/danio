...
Current verification note: as of the backup shared-preferences payload validation
slice on 2026-06-14, `flutter test` passes 1623 tests and `flutter analyze` is clean,
