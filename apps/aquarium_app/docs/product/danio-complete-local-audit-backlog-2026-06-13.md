...
Current verification note: as of the backup photo archive filename validation
slice on 2026-06-14, `flutter test` passes 1583 tests and `flutter analyze` is clean,
