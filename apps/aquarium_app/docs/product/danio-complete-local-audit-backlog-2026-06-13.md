...
| ID | Area | Work | Acceptance |
| --- | --- | --- | --- |
| CL-QA-001 | Screen audit | Re-run a whole-app phone screenshot and XML audit against the complete-local bar. | In progress; 2026-07-04 pass captured 19 current phone screenshot/XML pairs and logged pre-fix smoke failure evidence under `docs/qa/whole-app-phone-map-2026-07-04.md`. Smart/Fish ID bottom-dock overlap and smoke tap targeting are fixed locally, the phone black-box smoke rerun passed, and after-fix Smart root recapture shows Fish & Plant ID clearing the dock by `47px`. Remaining: finish every `SCREEN_INVENTORY.md` surface with pass/fail/gap notes. |
| CL-QA-002 | Tablet audit | Add tablet emulator/screenshot audit. | In progress; 2026-07-04 pass captured 19 current tablet screenshot/XML pairs and logged pre-fix smoke failure evidence under `docs/qa/whole-app-tablet-map-2026-07-04.md`. Tablet smoke route assertions/taps and lower More hub swipes are hardened locally, and the tablet black-box smoke rerun passed. Remaining: finish every `SCREEN_INVENTORY.md` tablet surface with pass/fail/gap notes. |
