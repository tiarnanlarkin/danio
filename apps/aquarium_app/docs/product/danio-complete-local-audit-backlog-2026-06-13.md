...
Current verification note: as of the species care-task creation slice on
2026-06-13, `flutter test` passes 1454 tests and `flutter analyze` is clean,
