...
Current verification note: as of the backup tank target ordering validation slice
on 2026-06-14, `flutter test` passes 1656 tests and `flutter analyze` is clean,
