...
Current verification note: as of the backup non-exportable preference validation
slice on 2026-06-14, `flutter test` passes 1628 tests and `flutter analyze` is clean,
