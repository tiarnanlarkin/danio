...
| CL-QA-007 | Debug tools | Expand QA seed states for emergencies, bad water, incompatible fish, skipped onboarding, demo mode, unlocks, tablet, and AI/no-AI. | In progress; CL-QA-007A adds a debug-only emergency unsafe-water seed that creates `QA Emergency Water Spike`, a sick livestock entry, and an unsafe ammonia/nitrite/nitrate water-test log through local storage. Remaining seed states: incompatible fish, skipped onboarding, unlock edge cases, tablet, and AI/no-AI. |
