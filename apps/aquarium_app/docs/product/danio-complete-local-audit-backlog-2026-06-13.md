...
| CL-P0-003 | Feature honesty | Re-audit all visible dormant/future/cloud/social/premium surfaces. | In progress; local/offline account copy, reward/shop mechanics, More reward copy, stale social comments, and visible debug-crash controls were fixed on 2026-06-13. Remaining passes: AI/premium, deeper debug/help, and public settings copy. |
