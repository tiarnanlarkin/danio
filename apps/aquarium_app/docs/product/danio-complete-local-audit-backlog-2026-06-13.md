...
| CL-P1-009 | Backup/data | Harden backup, restore, import validation, schema migration, edit/delete/undo, and normal-user explanations. | In progress; CL-P1-009A clarifies backup import safety copy, explains merge-vs-replace behavior for normal users, and protects Backup & Restore source copy from mojibake/non-ASCII glyphs. CL-P1-009B validates required backup data before preview/import. CL-P1-009C rejects malformed tank entries before backup preview/import. CL-P1-009D rejects duplicate tank IDs before backup preview/import. CL-P1-009E rejects logs, livestock, equipment, and tasks that reference missing backup tank IDs before preview/import. Remaining: deeper import validation UX, edit/delete/undo coverage, and restore/migration walkthrough QA. |
...
Current verification note: as of the backup child-relationship validation slice
on 2026-06-14, `flutter test` passes 1549 tests and `flutter analyze` is clean,
