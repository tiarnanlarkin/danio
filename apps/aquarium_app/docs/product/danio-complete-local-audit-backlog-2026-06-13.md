...
Current verification note: as of the plant care actions and wishlist save slice on
2026-06-13, `flutter test` passes 1450 tests and `flutter analyze` is clean,
