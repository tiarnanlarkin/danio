...
Current verification note: as of the backup cross-tank relationship validation
slice on 2026-06-14, `flutter test` passes 1634 tests and `flutter analyze` is clean,
