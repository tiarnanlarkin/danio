...
Current verification note: as of the backup recurring task due-date validation
slice on 2026-06-14, `flutter test` passes 1664 tests and `flutter analyze` is
