...
Current verification note: as of the backup water-test numeric validation slice
on 2026-06-14, `flutter test` passes 1570 tests and `flutter analyze` is clean,
