...
Current verification note: as of the backup numeric child-field validation slice
on 2026-06-14, `flutter test` passes 1581 tests and `flutter analyze` is clean,
