...
Current verification note: as of the backup water-test range validation slice
on 2026-06-14, `flutter test` passes 1642 tests and `flutter analyze` is clean,
