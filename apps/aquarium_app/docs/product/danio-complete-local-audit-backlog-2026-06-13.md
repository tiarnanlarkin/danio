...
| CL-P0-003 | Feature honesty | Re-audit all visible dormant/future/cloud/social/premium surfaces. | In progress; local/offline account copy, reward/shop mechanics, More reward copy, stale social comments, visible debug-crash controls, and Smart optional-AI copy were fixed on 2026-06-13. Remaining passes: deeper debug/help, public settings copy, and remaining planned/upgrade wording. |
