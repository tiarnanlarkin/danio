...
Current verification note: as of the backup optional-date validation slice on
2026-06-14, `flutter test` passes 1577 tests and `flutter analyze` is clean,
