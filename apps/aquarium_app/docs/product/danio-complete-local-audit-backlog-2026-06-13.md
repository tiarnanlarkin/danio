...
Current verification note: as of the backup tank numeric range validation slice
on 2026-06-14, `flutter test` passes 1652 tests and `flutter analyze` is clean,
