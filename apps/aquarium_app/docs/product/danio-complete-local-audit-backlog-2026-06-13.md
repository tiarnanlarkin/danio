...
Current verification note: as of the backup livestock count validation slice on
2026-06-14, `flutter test` passes 1636 tests and `flutter analyze` is clean,
