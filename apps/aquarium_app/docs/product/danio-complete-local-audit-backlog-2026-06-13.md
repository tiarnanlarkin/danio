...
Current verification note: as of the Backup tank-entry validation slice on
2026-06-13, `flutter test` passes 1536 tests and `flutter analyze` is clean,
