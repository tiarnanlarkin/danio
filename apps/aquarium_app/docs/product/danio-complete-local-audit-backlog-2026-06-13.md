...
Current verification note: as of the backup custom task recurrence validation
slice on 2026-06-14, `flutter test` passes 1662 tests and `flutter analyze` is
