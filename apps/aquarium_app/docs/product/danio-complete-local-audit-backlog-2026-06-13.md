...
| CL-P0-006 | Emergency access | Create accessible emergency flows for ammonia/nitrite spike, gasping, heater failure, filter failure, ich, injury, and poisoning. | In progress; CL-P0-006A makes Emergency Guide directly reachable from the Tank top bar. CL-P0-006B routes unsafe-water Tank alerts to Emergency Guide. CL-P0-006C adds an always-available Smart Hub emergency entry. CL-P0-006D routes urgent global searches to Emergency Guide. Remaining: emergency entry from More, lessons, species pages, and water logs. |
