...
Current verification note: as of the backup optional task-boolean validation
slice on 2026-06-14, `flutter test` passes 1616 tests and `flutter analyze` is clean,
