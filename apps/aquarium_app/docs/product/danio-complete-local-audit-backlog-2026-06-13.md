...
Current verification note: as of the backup shared-preferences restore preflight
slice on 2026-06-14, `flutter test` passes 1627 tests and `flutter analyze` is clean,
