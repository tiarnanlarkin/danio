...
Current verification note: as of the backup referenced-photo validation slice on
2026-06-14, `flutter test` passes 1610 tests and `flutter analyze` is clean,
