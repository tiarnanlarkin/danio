...
Current verification note: as of the backup child numeric range validation slice
on 2026-06-14, `flutter test` passes 1648 tests and `flutter analyze` is clean,
