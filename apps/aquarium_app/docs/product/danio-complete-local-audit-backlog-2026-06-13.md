...
Current verification note: as of the backup nested-log validation slice on
2026-06-14, `flutter test` passes 1569 tests and `flutter analyze` is clean,
