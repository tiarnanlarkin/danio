...
Current verification note: as of the Journal milestone timeline slice on
2026-06-13, `flutter test` passes 1539 tests and `flutter analyze` is clean,
