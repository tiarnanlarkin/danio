...
Current verification note: as of the backup shared-preferences value validation
slice on 2026-06-14, `flutter test` passes 1625 tests and `flutter analyze` is clean,
