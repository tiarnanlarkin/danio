...
Current verification note: as of the optional-restore preference failure reporting
slice on 2026-06-14, `flutter test` passes 1629 tests and `flutter analyze` is clean,
