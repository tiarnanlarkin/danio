...
Current verification note: as of the optional cloud-restore orphan child-record
slice on 2026-06-14, `flutter test` passes 1567 tests and `flutter analyze` is clean,
