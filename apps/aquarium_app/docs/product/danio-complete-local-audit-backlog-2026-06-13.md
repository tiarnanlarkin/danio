...
Current verification note: as of the backup record timestamp ordering validation
slice on 2026-06-14, `flutter test` passes 1660 tests and `flutter analyze` is
