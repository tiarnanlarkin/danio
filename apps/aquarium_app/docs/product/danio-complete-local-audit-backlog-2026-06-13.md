...
Current verification note: as of the backup optional child-string validation
slice on 2026-06-14, `flutter test` passes 1614 tests and `flutter analyze` is clean,
