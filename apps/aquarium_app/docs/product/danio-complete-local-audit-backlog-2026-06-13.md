...
| CL-P1-002 | Rewards | Connect progression to meaningful unlocks: rooms, tank vibes, decorations, seasonal themes, badges, and achievement-based cosmetics. | In progress; CL-P1-002A adds room vibe unlocks in the theme picker using local species, XP, streak, lesson, perfect-score, and achievement progress. Remaining: deeper decoration/seasonal cosmetics, badge display polish, and achievement-based tank cosmetics. |
...
Current verification note: as of the room-vibe unlock slice on 2026-06-13,
`flutter test` passes 1431 tests and `flutter analyze` is clean,
