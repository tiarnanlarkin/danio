...
Current verification note: as of the backup integer child-field validation slice
on 2026-06-14, `flutter test` passes 1587 tests and `flutter analyze` is clean,
