...
Current verification note: as of the species Watch For guidance slice on
2026-06-13, `flutter test` passes 1451 tests and `flutter analyze` is clean,
