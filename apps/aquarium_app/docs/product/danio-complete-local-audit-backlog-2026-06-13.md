...
Current verification note: as of the Cycling Assistant guided-actions slice on
2026-06-13, `flutter test` passes 1516 tests and `flutter analyze` is clean,
