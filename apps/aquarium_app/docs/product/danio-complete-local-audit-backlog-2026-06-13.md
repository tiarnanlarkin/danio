...
Current verification note: as of the backup child metadata-date validation slice
on 2026-06-14, `flutter test` passes 1608 tests and `flutter analyze` is clean,
