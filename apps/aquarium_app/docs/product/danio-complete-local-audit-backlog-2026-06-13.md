...
| CL-P0-006 | Emergency access | Create accessible emergency flows for ammonia/nitrite spike, gasping, heater failure, filter failure, ich, injury, and poisoning. | In progress; CL-P0-006A makes Emergency Guide directly reachable from the Tank top bar. Remaining: emergency entry from Tank alerts, Smart, Search/More, lessons, species pages, and water logs. |
