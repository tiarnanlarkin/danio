...
Current verification note: as of the duplicate backup tank-ID validation slice
on 2026-06-14, `flutter test` passes 1545 tests and `flutter analyze` is clean,
