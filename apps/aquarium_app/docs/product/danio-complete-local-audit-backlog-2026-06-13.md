...
Current verification note: as of the Compatibility guided workflow slice on
2026-06-13, `flutter test` passes 1512 tests and `flutter analyze` is clean,
