...
Current verification note: as of the tank-context practice recommendation slice
on 2026-06-13, `flutter test` passes 1496 tests and `flutter analyze` is clean,
