...
Current verification note: as of the Water Change guided workflow slice on
2026-06-13, `flutter test` passes 1499 tests and `flutter analyze` is clean,
