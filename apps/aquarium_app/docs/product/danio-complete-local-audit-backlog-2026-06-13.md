...
Current verification note: as of the backup equipment settings validation slice
on 2026-06-14, `flutter test` passes 1617 tests and `flutter analyze` is clean,
