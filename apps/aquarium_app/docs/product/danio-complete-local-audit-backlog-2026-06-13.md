...
| CL-P0-007 | Non-AI intelligence | Build the rule-based Aquarium Intelligence hub before expanding AI. | In progress; CL-P0-007A adds a no-AI Smart Aquarium Intelligence section and local rule engine for risks, care actions, compatibility signals, anomaly history, equipment maintenance, and visible reasons. Remaining: deeper care-plan flows and richer drill-downs. |
