...
Current verification note: as of the achievement cosmetic reward feedback slice
on 2026-06-13, `flutter test` passes 1438 tests and `flutter analyze` is clean,
