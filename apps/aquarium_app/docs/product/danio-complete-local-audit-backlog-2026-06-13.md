...
Current verification note: as of the Global Search destination/log search slice
on 2026-06-13, `flutter test` passes 1529 tests and `flutter analyze` is clean,
