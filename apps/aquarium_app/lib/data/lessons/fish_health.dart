    ...
    Lesson(
      ...
      sections: [
        ...
        const LessonSection(
          type: LessonSectionType.tip,
          content:
              'Epsom salt baths (1 tablespoon per 4 litres / 1 gallon for 15 minutes) can help reduce swelling and discomfort while medications take effect. Never use table salt — it contains anti-caking agents.',
        ),
      ],
      quiz: Quiz(
