...
const List<SpeciesInfo> _allSpecies = [
  ...
  SpeciesInfo(
    ...
    minSchoolSize: 1,
    temperament: 'Peaceful',
    diet: 'Omnivore — quality pellets, flakes, blanched vegetables, frozen foods',
    adultSizeCm: 20,
    swimLevel: 'Middle',
    description:
        'Domesticated goldfish bred for ornamental features — flowing fins, round bodies, and varied colours. Produce a lot of waste, so excellent filtration is essential. Not suitable for bowls. Can be kept singly or in groups.',
    compatibleWith: [
  ...
  SpeciesInfo(
    ...
    minSchoolSize: 1,
    temperament: 'Semi-aggressive',
    diet: 'Carnivore — quality pellets, earthworms, insects, frozen fish',
    adultSizeCm: 35,
    swimLevel: 'Middle',
    description:
