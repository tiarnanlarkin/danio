...
const List<SpeciesInfo> _allSpecies = [
  ...
  SpeciesInfo(
    ...
    swimLevel: 'Middle',
    description:
        'Also known as Galaxy Rasbora. Deep blue body with pearl-like spots and red fins. Stunning in planted nano tanks. Males spar but rarely harm each other.',
    compatibleWith: ['Small peaceful fish', 'Shrimp', 'Snails'],
    avoidWith: ['Large fish', 'Aggressive fish', 'Fast feeders'],
  ),
];
