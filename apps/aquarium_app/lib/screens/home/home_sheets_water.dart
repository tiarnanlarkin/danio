      ...
      children: [
        ...
        if (wt == null || !wt.hasValues) ...[
          ...
          buildParamRow(
            context,
            'Ammonia',
            wt.ammonia != null ? '${wt.ammonia!.toStringAsFixed(2)} ppm' : '--',
            '0 ppm',
          ),
          buildParamRow(
            context,
            'Nitrite',
            wt.nitrite != null ? '${wt.nitrite!.toStringAsFixed(2)} ppm' : '--',
            '0 ppm',
          ),
          buildParamRow(
            context,
            'Nitrate',
            wt.nitrate != null ? '${wt.nitrate!.toStringAsFixed(1)} ppm' : '--',
            '<40 ppm',
          ),
