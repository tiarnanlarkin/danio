...
String _maintenanceTaskId(String equipmentId) => 'equip_${equipmentId}_maintenance';

/// Ensure an auto-generated maintenance task exists (or is removed) based on equipment interval.
Future<void> _syncEquipmentMaintenanceTask(StorageService storage, Equipment equipment) async {
  ...
  final description = 'Maintenance for ${equipment.typeName}${equipment.brand != null ? ' (${equipment.brand})' : ''}';
...
class EquipmentScreen extends ConsumerWidget {
  ...
  void _showEquipmentHistoryDialog(BuildContext context, Equipment equipment) {
    showDialog(
      context: context,
      builder: (_) => _EquipmentHistoryDialog(tankId: tankId, equipment: equipment),
    );
  }
}
...
class _EquipmentHistoryDialog extends ConsumerWidget {
  ...
  const _EquipmentHistoryDialog({required this.tankId, required this.equipment});
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, i) {
                  ...
                  return ListTile(
                    ...
                    leading: const Icon(Icons.build_circle, color: AppColors.success, size: 18),
