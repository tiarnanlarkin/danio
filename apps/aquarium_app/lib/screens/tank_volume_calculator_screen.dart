...
const double _maxTankVolumeReadableWidth = 720;
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: SingleChildScrollView(
          ...
          child: _TankVolumeReadableFrame(
            child: Column(
...
class _TankVolumeReadableFrame extends StatelessWidget {
  final Widget child;

  const _TankVolumeReadableFrame({required this.child});
    ...
    return Align(
      ...
      child: ConstrainedBox(
        constraints: const BoxConstraints(
          maxWidth: _maxTankVolumeReadableWidth,
        ),
        child: child,
      ),
    );
