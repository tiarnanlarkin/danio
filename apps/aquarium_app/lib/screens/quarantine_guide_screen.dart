...
const double _maxQuarantineReadableWidth = 720;
      ...
      AppCard(
        ...
        child: Column(
          ...
          children: [
            ...
            _TipItem(
              text: 'Take photos of fish when they arrive for comparison later',
            ),
          ],
        ),
      ),
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) =>
            _QuarantineReadableFrame(child: items[index]),
...
class _QuarantineReadableFrame extends StatelessWidget {
  final Widget child;

  const _QuarantineReadableFrame({required this.child});
    ...
    return Align(
      ...
      child: ConstrainedBox(
        constraints: const BoxConstraints(
          maxWidth: _maxQuarantineReadableWidth,
        ),
        child: child,
      ),
    );
