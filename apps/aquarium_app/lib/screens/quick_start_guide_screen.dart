...
const double _maxQuickStartReadableWidth = 720;
      ...
      _StepCard(
        ...
        content: Column(
          ...
          children: [
            ...
            _NumberedStep(
              num: 2,
              text: 'Float bag for 15-20 minutes (temperature equalization)',
            ),
            _NumberedStep(
              num: 3,
            ...
            const SizedBox(height: AppSpacing.sm),
            _TipBox(
              text: 'Add fish slowly over weeks - don\'t stock all at once!',
            ),
          ],
        ),
      ),
      ...
      _StepCard(
        ...
        content: Column(
          ...
          children: [
            ...
            _BulletPoint(
              text: 'Rinse filter media in old tank water (never tap water)',
            ),
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) =>
            _QuickStartReadableFrame(child: items[index]),
...
class _QuickStartReadableFrame extends StatelessWidget {
  final Widget child;

  const _QuickStartReadableFrame({required this.child});
    ...
    return Align(
      ...
      child: ConstrainedBox(
        constraints: const BoxConstraints(
          maxWidth: _maxQuickStartReadableWidth,
        ),
        child: child,
      ),
    );
