        ...
        children: [
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text('Your First Aquarium', style: AppTypography.headlineMedium),
          ...
          _StepCard(
            ...
            content: Column(
              ...
              children: [
                _BulletPoint(text: 'Bigger is better — easier to maintain stable water'),
                _BulletPoint(text: 'Minimum 40L (10 gal) for beginners'),
                _BulletPoint(text: 'Consider where you\'ll put it (level, sturdy surface)'),
                _BulletPoint(text: '1L of water = 1kg weight — plan accordingly'),
                const SizedBox(height: 8),
                _TipBox(text: 'Starter kit bundles often include filter, heater, and light.'),
              ],
            ),
          ),
          ...
          _StepCard(
            ...
            content: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _NumberedStep(num: 1, text: 'Place tank on level, sturdy surface away from windows'),
                _NumberedStep(num: 2, text: 'Rinse substrate thoroughly (no soap!)'),
                _NumberedStep(num: 3, text: 'Add substrate (5-8cm depth)'),
                _NumberedStep(num: 4, text: 'Add hardscape (rocks, driftwood)'),
                _NumberedStep(num: 5, text: 'Fill with water — pour onto plate to avoid disturbing substrate'),
          ...
          _StepCard(
            ...
            content: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                _NumberedStep(num: 1, text: 'Add ammonia source (fish food or pure ammonia)'),
                _NumberedStep(num: 2, text: 'Test water every 2-3 days'),
                _NumberedStep(num: 3, text: 'Wait for ammonia spike, then nitrite spike'),
                _NumberedStep(num: 4, text: 'Cycle is complete when ammonia = 0, nitrite = 0, nitrate > 0'),
                const SizedBox(height: 8),
                _WarningBox(text: 'DO NOT add fish until the cycle is complete. This is the #1 beginner mistake.'),
              ],
            ),
          ),
          ...
          _StepCard(
            ...
            content: Column(
              ...
              children: [
                ...
                _BulletPoint(text: 'Tetras (neons, cardinals) — need groups of 6+'),
          ...
          _StepCard(
            ...
            content: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _NumberedStep(num: 1, text: 'Buy from reputable store — avoid sick-looking fish'),
                _NumberedStep(num: 2, text: 'Float bag for 15-20 minutes (temperature equalization)'),
                _NumberedStep(num: 3, text: 'Add tank water to bag gradually over 20-30 minutes'),
                _NumberedStep(num: 4, text: 'Net fish into tank — discard bag water'),
                _NumberedStep(num: 5, text: 'Keep lights off for a few hours'),
                _NumberedStep(num: 6, text: 'Don\'t feed for 24 hours'),
                const SizedBox(height: 8),
                _TipBox(text: 'Add fish slowly over weeks — don\'t stock all at once!'),
              ],
            ),
          ),
          ...
          _StepCard(
            ...
            content: Column(
              ...
              children: [
                ...
                _BulletPoint(text: 'Test water (at least ammonia, nitrite, nitrate)'),
                ...
                _BulletPoint(text: 'Rinse filter media in old tank water (never tap water)'),
                _BulletPoint(text: 'Trim plants'),
                _BulletPoint(text: 'Check equipment'),
                const SizedBox(height: 8),
                Text('Daily:', style: AppTypography.labelLarge),
                _BulletPoint(text: 'Feed once or twice (only what they eat in 2 minutes)'),
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text('Common Beginner Mistakes', style: AppTypography.headlineSmall),
                    ],
                  ),
                  const SizedBox(height: 12),
                  _MistakeItem(mistake: 'Adding fish before cycling', result: 'Fish die from ammonia poisoning'),
                  _MistakeItem(mistake: 'Overfeeding', result: 'Ammonia spikes, obesity, water quality issues'),
                  _MistakeItem(mistake: 'Overstocking', result: 'Stress, aggression, poor water quality'),
                  _MistakeItem(mistake: 'Cleaning filter in tap water', result: 'Kills beneficial bacteria'),
                  _MistakeItem(mistake: 'Changing too much water at once', result: 'Stress, parameter swings'),
                  _MistakeItem(mistake: 'Not researching fish', result: 'Incompatible tankmates, wrong conditions'),
                ],
              ),
            ),
          ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(duration, style: AppTypography.bodySmall.copyWith(color: AppColors.textSecondary)),
                    ],
                  ),
                ),
              ],
          ...
          Expanded(
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  TextSpan(text: mistake, style: const TextStyle(fontWeight: FontWeight.w600)),
