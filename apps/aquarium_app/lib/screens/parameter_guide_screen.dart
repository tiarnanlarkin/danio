...
const double _maxParameterReadableWidth = 720;
    ...
    final items = <Widget>[
      ...
      _ParameterSection(
        ...
        tips: [
          ...
          'Crushed coral and limestone raise pH',
      ...
      _ParameterSection(
        ...
        tips: [
          ...
          'Gradual changes under 2 C per hour',
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) =>
            _ParameterReadableFrame(child: items[index]),
...
class _ParameterReadableFrame extends StatelessWidget {
  final Widget child;

  const _ParameterReadableFrame({required this.child});
  ...
  Widget build(BuildContext context) {
    return Align(
      ...
      child: ConstrainedBox(
        constraints: const BoxConstraints(maxWidth: _maxParameterReadableWidth),
        child: child,
      ),
    );
  }
