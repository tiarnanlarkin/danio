...
class AppColors {
  ...
  static const Color primary = Color(0xFF5B9A8B);        // Soft teal
  static const Color primaryLight = Color(0xFF7FC8B6);   // Light seafoam
  static const Color primaryDark = Color(0xFF3D7068);    // Deep teal

  // Secondary - Warm sand/coral accents
  static const Color secondary = Color(0xFFE8A87C);      // Soft coral/peach
  static const Color secondaryLight = Color(0xFFF5D0B5); // Light sand
  static const Color secondaryDark = Color(0xFFCB8B65);  // Warm amber
  ...
  // Semantic colors
  static const Color success = Color(0xFF7AC29A);        // Soft green
  static const Color warning = Color(0xFFE8B86D);        // Warm amber
  static const Color error = Color(0xFFE88B8B);          // Soft coral red
  static const Color info = Color(0xFF7EB8D8);           // Soft blue

  // Parameter status colors (legacy compatibility)
  static const Color paramSafe = Color(0xFF7AC29A);
  static const Color paramWarning = Color(0xFFE8B86D);
  static const Color paramDanger = Color(0xFFE88B8B);
  ...
  static const Color textHint = Color(0xFFB2BEC3);       // Light gray
  ...
  static const Color textHintDark = Color(0xFF6B7D8A);
