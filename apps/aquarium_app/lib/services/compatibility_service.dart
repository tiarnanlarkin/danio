...
class CompatibilityService {
  ...
  static List<CompatibilityIssue> checkLivestockCompatibility({
    ...
    if (targets.tempMin != null || targets.tempMax != null) {
      ...
      if (species.maxTempC < tankMin) {
        issues.add(CompatibilityIssue(
          ...
          suggestion: 'Consider lowering tank temperature or choosing a different species.',
        ));
        ...
        issues.add(CompatibilityIssue(
          ...
          suggestion: 'Consider raising tank temperature or choosing a different species.',
        ));
      } else if (species.minTempC < tankMin - 2 || species.maxTempC > tankMax + 2) {
        issues.add(CompatibilityIssue(
    ...
    if (targets.phMin != null || targets.phMax != null) {
      ...
      } else if (species.minPh < tankPhMin - 0.3 || species.maxPh > tankPhMax + 0.3) {
        issues.add(CompatibilityIssue(
          level: CompatibilityLevel.warning,
      ...
      if (targets.ghMin != null || targets.ghMax != null) {
        ...
        if (species.maxGh! < tankGhMin - 2) {
          issues.add(CompatibilityIssue(
            ...
            suggestion: 'Consider using RO water or peat filtration to soften.',
          ));
          ...
          issues.add(CompatibilityIssue(
            ...
            suggestion: 'Consider adding mineral supplements or crushed coral.',
          ));
        }
      }
    }
    ...
    if (species.minSchoolSize > 1 && livestock.count < species.minSchoolSize) {
      issues.add(CompatibilityIssue(
        ...
        suggestion: 'Consider adding more to reduce stress and encourage natural behavior.',
      ));
    }
    ...
    for (final existing in existingLivestock) {
      ...
      final existingSpecies = SpeciesDatabase.lookup(existing.commonName) ??
